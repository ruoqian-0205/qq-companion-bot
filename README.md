...
注意:**基本信息、关系、偏好、约定这几类不会因为"很久没提到"而失去价值**,所以取舍的主依据是 `n` 而不是 `seen`。
...
```
长期记忆（10001）已压缩：L0 -80 条，现有 83 条；L1 共 78/80 条（基本信息 17、重要关系 11、偏好与雷区 16、约定与承诺 12、近期事件 22），n>1 的 31 条
```
