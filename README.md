...
| `lm_l1_max_facts` | `80`               | 事实库整库**条目数**上限(按条数算,不按字数) |
...
```
长期记忆（10001）已压缩：L0 -80 条，现有 83 条；L1 共 70/80 条（基本信息 14、重要关系 8、偏好与雷区 12、约定与承诺 6、近期事件 10、我的立场 9、我们之间 11），n>1 的 31 条
```
